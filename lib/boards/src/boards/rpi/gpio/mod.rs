...
impl GPIO {
    ...
    fn get_fsel_bit_field(pin: &Pin) -> u32 {
        match pin {
            ...
            Pin::Ten                => GPFSEL1BitField::FSEL0 as u32,
            Pin::Eleven             => GPFSEL1BitField::FSEL1 as u32,
            Pin::Twelve             => GPFSEL1BitField::FSEL2 as u32,
            Pin::Thirteen           => GPFSEL1BitField::FSEL3 as u32,
            Pin::Fourteen           => GPFSEL1BitField::FSEL4 as u32,
            Pin::Fifteen            => GPFSEL1BitField::FSEL5 as u32,
            Pin::Sixteen            => GPFSEL1BitField::FSEL6 as u32,
            Pin::Seventeen          => GPFSEL1BitField::FSEL7 as u32,
            Pin::Eighteen           => GPFSEL1BitField::FSEL8 as u32,
            Pin::Nineteen           => GPFSEL1BitField::FSEL9 as u32,
            Pin::Twenty             => GPFSEL2BitField::FSEL0 as u32,
            Pin::TwentyOne          => GPFSEL2BitField::FSEL1 as u32,
            Pin::TwentyTwo          => GPFSEL2BitField::FSEL2 as u32,
            Pin::TwentyThree        => GPFSEL2BitField::FSEL3 as u32,
            Pin::TwentyFour         => GPFSEL2BitField::FSEL4 as u32,
            Pin::TwentyFive         => GPFSEL2BitField::FSEL5 as u32,
            Pin::TwentySix          => GPFSEL2BitField::FSEL6 as u32,
            Pin::TwentySeven        => GPFSEL2BitField::FSEL7 as u32,
        }
    }
